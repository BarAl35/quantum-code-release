...
**Recommended:** **[Release v0.1.5](https://github.com/BarAl35/quantum-code-release/releases/tag/v0.1.5)** (Windows `.exe` / `.msi`; macOS when added).

**Current Windows build:** [`downloads/v0.1.5/windows/`](https://github.com/BarAl35/quantum-code-release/tree/main/downloads/v0.1.5/windows) (`.exe`, `.msi`).

| Platform | Path |
| --- | --- |
| Windows (latest) | [`downloads/v0.1.5/windows/`](https://github.com/BarAl35/quantum-code-release/tree/main/downloads/v0.1.5/windows) |
| Windows (previous) | [`downloads/v0.1.4/windows/`](https://github.com/BarAl35/quantum-code-release/tree/main/downloads/v0.1.4/windows) |
| Windows (legacy) | [`downloads/v0.1.0/windows/`](https://github.com/BarAl35/quantum-code-release/tree/main/downloads/v0.1.0/windows) |
| macOS | `.dmg` on **Releases** when published (`downloads/v0.1.5/macos/`) |
...
4. Open **Quantum Code** from the Start menu. Check **About** for version **0.1.5+** if Settings failed on an older build.
