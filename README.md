...
**Recommended:** **[Release v0.1.6](https://github.com/BarAl35/quantum-code-release/releases/tag/v0.1.6)** (Windows `.exe` / `.msi`; macOS when added).

**Current Windows build:** [`downloads/v0.1.6/windows/`](https://github.com/BarAl35/quantum-code-release/tree/main/downloads/v0.1.6/windows) (`.exe`, `.msi`).

| Platform | Path |
| --- | --- |
| Windows (latest) | [`downloads/v0.1.6/windows/`](https://github.com/BarAl35/quantum-code-release/tree/main/downloads/v0.1.6/windows) |
| Windows (previous) | [`downloads/v0.1.5/windows/`](https://github.com/BarAl35/quantum-code-release/tree/main/downloads/v0.1.5/windows) |
| Windows (legacy) | [`downloads/v0.1.0/windows/`](https://github.com/BarAl35/quantum-code-release/tree/main/downloads/v0.1.0/windows) |
| macOS | `.dmg` on **Releases** when published (`downloads/v0.1.6/macos/`) |
...
4. Open **Quantum Code** from the Start menu. Check **About** for version **0.1.6+** if Settings failed on an older build.
